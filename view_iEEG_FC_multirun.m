% plot iEEG HFB FC on surface using average FC values across multiple runs
% of condition
% must first run iEEG_FC_HFB.m

%Patient=input('Patient: ','s');
Patient='S17_116';
rest='2'; % 'Rest(1) Sleep(0) gradCPT (2)?
runnames=[1 3 4 5 6 7];
freq='9';
elec_number='92';

plot_prctile=0; % plot percentile values of FC relative to all values
hemi='r';
iEEG='1';
view_bad='1';
depth='0';
...
%freq=input('HFB 0.1-1Hz (1) alpha (2) beta1 (3) beta2 (4) Gamma (5) Delta (6) Theta (7) all (8) <0.1 Hz HFB (9) ','s');
