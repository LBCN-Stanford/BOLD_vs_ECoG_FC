...
matlabbatch{1}.spm.meeg.preproc.filter.freq = 0.05;
matlabbatch{1}.spm.meeg.preproc.filter.dir = 'twopass';
matlabbatch{1}.spm.meeg.preproc.filter.order = 4;
matlabbatch{1}.spm.meeg.preproc.filter.prefix = 'ultraslow';
disp('Done low-pass filtering (<0.05 Hz) averaged HFB time series');
