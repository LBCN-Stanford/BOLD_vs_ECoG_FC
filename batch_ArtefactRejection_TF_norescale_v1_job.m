...
matlabbatch{1}.spm.meeg.preproc.artefact.mode = 'mark'; % must be 'mark' for non-epoched data
...
% matlabbatch{3}.spm.meeg.tf.avgfreq.D(1) = cfg_dep('Averaging 70-170 Hz datafile', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','Dfname'));
% matlabbatch{3}.spm.meeg.tf.avgfreq.freqwin = [70 170];
% matlabbatch{3}.spm.meeg.tf.avgfreq.prefix = 'HFB';
...
% matlabbatch{4}.spm.meeg.tf.avgfreq.D(1) = cfg_dep('Time-frequency rescale: Rescaled TF Datafile', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','Dfname'));
