...
HFB_fast_mat=HFB_fast_allcorr; HFB_fast_mat(find(HFB_fast_mat==1))=NaN; HFB_fast_mat(find(BOLD_allcorr==1))=NaN;
alpha_fast_mat=alpha_fast_allcorr; alpha_fast_mat(find(alpha_fast_mat==1))=NaN; alpha_fast_mat(find(BOLD_allcorr==1))=NaN;
beta1_fast_mat=beta1_fast_allcorr; beta1_fast_mat(find(beta1_fast_mat==1))=NaN; beta1_fast_mat(find(BOLD_allcorr==1))=NaN;
beta2_fast_mat=beta2_fast_allcorr; beta2_fast_mat(find(beta2_fast_mat==1))=NaN; beta2_fast_mat(find(BOLD_allcorr==1))=NaN;
Theta_fast_mat=Theta_fast_allcorr; Theta_fast_mat(find(Theta_fast_mat==1))=NaN; Theta_fast_mat(find(BOLD_allcorr==1))=NaN;
Delta_fast_mat=Delta_fast_allcorr; Delta_fast_mat(find(Delta_fast_mat==1))=NaN; Delta_fast_mat(find(BOLD_allcorr==1))=NaN;
Gamma_fast_mat=Gamma_fast_allcorr; Gamma_fast_mat(find(Gamma_fast_mat==1))=NaN; Gamma_fast_mat(find(BOLD_allcorr==1))=NaN;
