...
Alpha_fast=spm_eeg_load(['fastAlpha' Mfile]);
Beta1_fast=spm_eeg_load(['fastBeta1' Mfile]);
Beta2_fast=spm_eeg_load(['fastBeta2' Mfile]);
Delta_fast=spm_eeg_load(['fastDelta' Mfile]);
Theta_fast=spm_eeg_load(['fastTheta' Mfile]);
Gamma_fast=spm_eeg_load(['fastGamma' Mfile]);
