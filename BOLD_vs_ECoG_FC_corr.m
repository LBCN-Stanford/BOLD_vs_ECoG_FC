...
runname=input('Run name (subfolder name): ','s');
...
% Load preprocessed iEEG data (HGP and lowpass filtered)
if tdt==1 && tf_type==1
cd([globalECoGDir '/Rest/' Patient '/' runname]);
HFB=load(['pHFBtf_aMfffdspm8_iEEG' runname '.mat']);
HFB_spm_data=spm_eeg_load(['pHFBtf_aMfffdspm8_iEEG' runname '.mat']);
slow=load(['slowpHFBtf_aMfffdspm8_iEEG' runname '.mat']);
slow_spm_data=spm_eeg_load(['slowpHFBtf_aMfffdspm8_iEEG' runname '.mat']);
medium=load(['bptf_mediumpHFBtf_aMfffdspm8_iEEG' runname '.mat']);
medium_spm_data=spm_eeg_load(['bptf_mediumpHFBtf_aMfffdspm8_iEEG' runname '.mat']);
alpha=load(['bptf_mediumpAlphatf_aMfffdspm8_iEEG' runname '.mat']);
alpha_spm_data=spm_eeg_load(['bptf_mediumpAlphatf_aMfffdspm8_iEEG' runname '.mat']);
beta1=load(['bptf_mediumpBeta1tf_aMfffdspm8_iEEG' runname '.mat']);
beta1_spm_data=spm_eeg_load(['bptf_mediumpBeta1tf_aMfffdspm8_iEEG' runname '.mat']);

elseif tdt==1 && tf_type==2
    cd([globalECoGDir '/Rest/' Patient '/' runname]);
    HFB=load(['pHFBhilberttf_aMfffdspm8_iEEG' runname '.mat']);
    HFB_spm_data=spm_eeg_load(['pHFBhilberttf_aMfffdspm8_iEEG' runname '.mat']);
slow=load(['slowpHFBhilberttf_aMfffdspm8_iEEG' runname '.mat']);
slow_spm_data=spm_eeg_load(['slowpHFBhilberttf_aMfffdspm8_iEEG' runname '.mat']);
medium=load(['bptf_mediumpHFBhilberttf_aMfffdspm8_iEEG' runname '.mat']);
medium_spm_data=spm_eeg_load(['bptf_mediumpHFBhilberttf_aMfffdspm8_iEEG' runname '.mat']);
alpha=load(['bptf_mediumpAlphahilberttf_aMfffdspm8_iEEG' runname '.mat']);
alpha_spm_data=spm_eeg_load(['bptf_mediumpAlphahilberttf_aMfffdspm8_iEEG' runname '.mat']);
beta1=load(['bptf_mediumpBeta1hilberttf_aMfffdspm8_iEEG' runname '.mat']);
beta1_spm_data=spm_eeg_load(['bptf_mediumpBeta1hilberttf_aMfffdspm8_iEEG' runname '.mat']);

elseif tdt==0 && tf_type==1
cd([globalECoGDir '/Rest/' Patient '/' runname]);
HFB=load(['pHFBtf_aMfffECoG_' edfname '.mat']);
HFB_spm_data=spm_eeg_load(['pHFBtf_aMfffECoG_' edfname '.mat']);
slow=load(['slowpHFBtf_aMfffECoG_' edfname '.mat']);
slow_spm_data=spm_eeg_load(['slowpHFBtf_aMfffECoG_' edfname '.mat']);
medium=load(['bptf_mediumpHFBtf_aMfffECoG_' edfname '.mat']);
medium_spm_data=spm_eeg_load(['bptf_mediumpHFBtf_aMfffECoG_' edfname '.mat']);
alpha=load(['bptf_mediumpAlphatf_aMfffECoG_' edfname '.mat']);
alpha_spm_data=spm_eeg_load(['bptf_mediumpAlphatf_aMfffECoG_' edfname '.mat']);
beta1=load(['bptf_mediumpBeta1tf_aMfffECoG_' edfname '.mat']);
beta1_spm_data=spm_eeg_load(['bptf_mediumpBeta1tf_aMfffECoG_' edfname '.mat']);

elseif tdt==0 && tf_type==2
cd([globalECoGDir '/Rest/' Patient '/' runname]);
HFB=load(['pHFBhilberttf_aMfffECoG_' edfname '.mat']);
HFB_spm_data=spm_eeg_load(['pHFBhilberttf_aMfffECoG_' edfname '.mat']);
slow=load(['slowpHFBhilberttf_aMfffECoG_' edfname '.mat']);
slow_spm_data=spm_eeg_load(['slowpHFBhilberttf_aMfffECoG_' edfname '.mat']);
medium=load(['bptf_mediumpHFBhilberttf_aMfffECoG_' edfname '.mat']);
medium_spm_data=spm_eeg_load(['bptf_mediumpHFBhilberttf_aMfffECoG_' edfname '.mat']);
alpha=load(['bptf_mediumpAlphahilberttf_aMfffECoG_' edfname '.mat']);
alpha_spm_data=spm_eeg_load(['bptf_mediumpAlphahilberttf_aMfffECoG_' edfname '.mat']);
beta1=load(['bptf_mediumpBeta1hilberttf_aMfffECoG_' edfname '.mat']);
beta1_spm_data=spm_eeg_load(['bptf_mediumpBeta1hilberttf_aMfffECoG_' edfname '.mat']);
...
if rm_last==1
for slow_chan=1:total_bold;
    slow_electrode_ts(:,slow_chan)=slow.D.data(slow_chan,:)';   
end

for medium_chan=1:total_bold;
    medium_electrode_ts(:,medium_chan)=medium.D.data(medium_chan,:)';   
end

for alpha_chan=1:total_bold;
    alpha_electrode_ts(:,alpha_chan)=alpha.D.data(alpha_chan,:)';   
end
for beta1_chan=1:total_bold;
    beta1_electrode_ts(:,beta1_chan)=beta1.D.data(beta1_chan,:)';   
end
for HFB_chan=1:total_bold;
    HFB_electrode_ts(:,HFB_chan)=HFB.D.data(HFB_chan,:)';   
end

else
for slow_chan=1:length(slow.D.channels);
    slow_electrode_ts(:,slow_chan)=slow.D.data(slow_chan,:)';   
end

for medium_chan=1:length(medium.D.channels);
    medium_electrode_ts(:,medium_chan)=medium.D.data(medium_chan,:)'; 
end   
  
for alpha_chan=1:length(alpha.D.channels);
    alpha_electrode_ts(:,alpha_chan)=alpha.D.data(alpha_chan,:)';   
end

for beta1_chan=1:length(beta1.D.channels);
    beta1_electrode_ts(:,beta1_chan)=beta1.D.data(beta1_chan,:)';   
end

for HFB_chan=1:length(HFB.D.channels);
    HFB_electrode_ts(:,HFB_chan)=HFB.D.data(HFB_chan,:)';   
end
...
%% iEEG-BOLD order transformations

% Transform BOLD time series to iEEG order
...
vox_iEEG_space=[];
% Transform elec coordinates to iEEG order and calculate euclidean distance matrix
for i=1:length(iElvis_to_iEEG_chanlabel)
    new_ind=iElvis_to_iEEG_chanlabel(i);
    elec_coord=vox(i,:);
...
bad_indices=HFB_spm_data.badchannels;

if HFB_spike_exclusion==1
for i=1:length(iElvis_to_iEEG_chanlabel);
    HFB_z=(HFB_electrode_ts(:,i)-mean(HFB_electrode_ts(:,i)))/std(HFB_electrode_ts(:,i));
    HFB_max=max(HFB_z);
    if HFB_max>HFB_zthresh;
        display(['Channel ' HFB_spm_data.chanlabels{i} ' excluded due to HFB spikes']);
...
for i=1:length(bad_indices)
    slow_electrode_ts(:,bad_indices(i))=NaN;
    medium_electrode_ts(:,bad_indices(i))=NaN;
    alpha_electrode_ts(:,bad_indices(i))=NaN;
    beta1_electrode_ts(:,bad_indices(i))=NaN;
...
difference=y1-vox_iEEG_space(:,2);
 if length(find(difference==0))>1
    slow_electrode_ts(:,i)=NaN;
    medium_electrode_ts(:,i)=NaN;
    alpha_electrode_ts(:,i)=NaN;
    beta1_electrode_ts(:,i)=NaN;
...
for i=1:length(overlap_elec)
    slow_electrode_ts(:,overlap_elec(i))=NaN;
    medium_electrode_ts(:,overlap_elec(i))=NaN;
    alpha_electrode_ts(:,overlap_elec(i))=NaN;
    beta1_electrode_ts(:,overlap_elec(i))=NaN;
...
slow_allcorr=corrcoef(slow_electrode_ts); slow_column=slow_allcorr(:);
medium_allcorr=corrcoef(medium_electrode_ts); medium_column=medium_allcorr(:);
alpha_allcorr=corrcoef(alpha_electrode_ts); alpha_column=alpha_allcorr(:);
beta1_allcorr=corrcoef(beta1_electrode_ts); beta1_column=beta1_allcorr(:);
...
medium_column(find(BOLD_column_ones==1))=NaN; medium_column(isnan(medium_column))=[];
%slow_column(find(slow_column==0))=NaN; 
slow_column(BOLD_column_ones==1)=NaN; slow_column(isnan(slow_column))=[];
alpha_column(BOLD_column_ones==1)=NaN; alpha_column(isnan(alpha_column))=[];
...
distance_column(find(BOLD_column_ones==1))=NaN; distance_column(isnan(distance_column))=[];
...
Yeo_CoreDMN_ECoG_medium_ts=medium_electrode_ts(:,find(Yeo_network_iEEG_space==1));
Yeo_CoreDMN_ECoG_slow_ts=slow_electrode_ts(:,find(Yeo_network_iEEG_space==1));
Yeo_CoreDMN_ECoG_alpha_ts=alpha_electrode_ts(:,find(Yeo_network_iEEG_space==1));
Yeo_CoreDMN_ECoG_beta1_ts=beta1_electrode_ts(:,find(Yeo_network_iEEG_space==1));
...
Yeo_DAN_ECoG_medium_ts=medium_electrode_ts(:,find(Yeo_network_iEEG_space==6));
Yeo_DAN_ECoG_slow_ts=slow_electrode_ts(:,find(Yeo_network_iEEG_space==6));
Yeo_DAN_ECoG_alpha_ts=alpha_electrode_ts(:,find(Yeo_network_iEEG_space==6));
Yeo_DAN_ECoG_beta1_ts=beta1_electrode_ts(:,find(Yeo_network_iEEG_space==6));
...
Yeo_VAN_ECoG_medium_ts=medium_electrode_ts(:,find(Yeo_network_iEEG_space==3));
Yeo_VAN_ECoG_slow_ts=slow_electrode_ts(:,find(Yeo_network_iEEG_space==3));
Yeo_VAN_ECoG_alpha_ts=alpha_electrode_ts(:,find(Yeo_network_iEEG_space==3));
Yeo_VAN_ECoG_beta1_ts=beta1_electrode_ts(:,find(Yeo_network_iEEG_space==3));
...
DMN_ECoG_medium_ts=medium_electrode_ts(:,find(network_iEEG_space==1));
DMN_ECoG_slow_ts=slow_electrode_ts(:,find(network_iEEG_space==1));
DMN_ECoG_alpha_ts=alpha_electrode_ts(:,find(network_iEEG_space==1));
DMN_ECoG_beta1_ts=beta1_electrode_ts(:,find(network_iEEG_space==1));
...
FPN_ECoG_medium_ts=medium_electrode_ts(:,find(network_iEEG_space==2));
FPN_ECoG_slow_ts=slow_electrode_ts(:,find(network_iEEG_space==2));
FPN_ECoG_alpha_ts=alpha_electrode_ts(:,find(network_iEEG_space==2));
FPN_ECoG_beta1_ts=beta1_electrode_ts(:,find(network_iEEG_space==2));
...
VAN_ECoG_medium_ts=medium_electrode_ts(:,find(network_iEEG_space==3));
VAN_ECoG_slow_ts=slow_electrode_ts(:,find(network_iEEG_space==3));
VAN_ECoG_alpha_ts=alpha_electrode_ts(:,find(network_iEEG_space==3));
VAN_ECoG_beta1_ts=beta1_electrode_ts(:,find(network_iEEG_space==3));
...
SMN_ECoG_medium_ts=medium_electrode_ts(:,find(network_iEEG_space==4));
SMN_ECoG_slow_ts=slow_electrode_ts(:,find(network_iEEG_space==4));
SMN_ECoG_alpha_ts=alpha_electrode_ts(:,find(network_iEEG_space==4));
SMN_ECoG_beta1_ts=beta1_electrode_ts(:,find(network_iEEG_space==4));
...
Visual_ECoG_medium_ts=medium_electrode_ts(:,find(network_iEEG_space==5));
Visual_ECoG_slow_ts=slow_electrode_ts(:,find(network_iEEG_space==5));
Visual_ECoG_alpha_ts=alpha_electrode_ts(:,find(network_iEEG_space==5));
Visual_ECoG_beta1_ts=beta1_electrode_ts(:,find(network_iEEG_space==5));
...
DAN_ECoG_medium_ts=medium_electrode_ts(:,find(network_iEEG_space==6));
DAN_ECoG_slow_ts=slow_electrode_ts(:,find(network_iEEG_space==6));
DAN_ECoG_alpha_ts=alpha_electrode_ts(:,find(network_iEEG_space==6));
DAN_ECoG_beta1_ts=beta1_electrode_ts(:,find(network_iEEG_space==6));
...
Language_ECoG_medium_ts=medium_electrode_ts(:,find(network_iEEG_space==7));
Language_ECoG_slow_ts=slow_electrode_ts(:,find(network_iEEG_space==7));
Language_ECoG_alpha_ts=alpha_electrode_ts(:,find(network_iEEG_space==7));
Language_ECoG_beta1_ts=beta1_electrode_ts(:,find(network_iEEG_space==7));
...
ECoG_duration_mins=(size(medium_spm_data,2)/1000)/60
