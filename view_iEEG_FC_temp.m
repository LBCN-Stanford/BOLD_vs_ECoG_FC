...
if iEEG=='2'
if freq=='1'
  print('-opengl','-r300','-dpng',strcat([pwd,filesep,'SBCA',filesep,'figs',filesep,'iEEG_BOLD_HFB_medium',filesep,[Rest '_'],'movie_HFB_medium_iEEG_FC_',elec_name,'_run' ecog_runname]));
elseif freq=='2'
